...
namespace Taf.Utility{
    ...
    public partial class Extensions{
        ...
        ///     返回更新后Dictionary列表
        /// </returns>
        public static Dictionary<TKey, TValue> AddOrNot<TKey, TValue>(
        ...
        public static Dictionary<TKey, TValue> AddRange<TKey, TValue>(
            this Dictionary<TKey, TValue> dict, IEnumerable<KeyValuePair<TKey, TValue>> values, bool replaceExisted){
