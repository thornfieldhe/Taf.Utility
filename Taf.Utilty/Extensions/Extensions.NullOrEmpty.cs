...
namespace Taf.Utility{
    ...
    public partial class Extensions{
        ...
        /// </returns>
        public static TResult WhenTrue<TResult>(this bool @this, TResult content) => @this ? content : default;
        ...
        ///     The <see cref="TResult" />.
        /// </returns>
        public static TResult WhenFalse<TResult>(this bool @this, Func<TResult> exp) => !@this ? exp() : default;
        ...
        ///     The <see cref="TResult" />.
        /// </returns>
        public static TResult WhenFalse<TResult>(this bool @this, TResult content) => !@this ? content : default;
        ...
        public static bool Between<T>(this T @this, T lower, T upper) where T : IComparable<T> =>
            @this.CompareTo(lower) >= 0 && @this.CompareTo(upper) < 0;
        ...
        ///     The <see cref="T" />.
        /// </returns>
        public static T SafeValue<T>(this T @this) where T : class, new() => new T();
        ...
        public static TReturn NullOr<T, TReturn>(
            this T           @this,
            Func<T, TReturn> exp,
            TReturn          elseValue = default) where T : class =>
