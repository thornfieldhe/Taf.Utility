...
namespace Taf.Utility{
    ...
    public static class OrderByExtention{
        ...
        /// <returns></returns>
        public static IOrderedEnumerable<T> OrderBy<T, R>(
            this IEnumerable<T> source, Func<T, R> keySelector
    ...
    public static class ThenByExtention{
        ...
        /// <typeparam name="R"></typeparam>
        /// <returns></returns>
        public static IOrderedEnumerable<T> ThenBy<T, R>(
            this IOrderedEnumerable<T> source, Func<T, R> keySelector
          , R[]                        sources) where R : IComparable<R> =>
