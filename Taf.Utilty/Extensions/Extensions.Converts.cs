...
namespace Taf.Utility{
    ...
    #region 字符串转换
        ...
        ///     The <see cref="int" />.
        /// </returns>
        public static int ToInt(this string @this, int defaultValue = default){
            int x;
        ...
        /// <returns>
        /// </returns>
        public static int? ToIntOrNull(this string @this, int defaultValue = default){
            if(@this == null){
                return null;
            }
        ...
        /// <returns>
        /// </returns>
        public static long ToLong(this string @this, long defaultValue = default){
            long x;
        ...
        /// <returns>
        /// </returns>
        public static double? ToDoubleOrNull(this string @this, double defaultValue = default){
            if(@this == null){
                return null;
            }
        ...
        /// <returns>
        /// </returns>
        public static decimal? ToDecimalOrNull(this string @this, decimal defaultValue = default){
            if(@this == null){
                return null;
            }
        ...
        /// <returns>
        /// </returns>
        public static float ToFloat(this string @this, float defaultValue = default){
            float x;
        ...
        public static Guid ToGuid(this string @this, Guid? defaultValue=null){
            Guid x;
            defaultValue.IfNull(()=>defaultValue = Guid.Empty);
            return Guid.TryParse(@this, out x) ? x : defaultValue.Value;
        }
        ...
        /// <returns>
        /// </returns>
        public static Guid? ToGuidOrNull(this string @this, Guid defaultValue = default){
            if(@this == null){
                return null;
            }
