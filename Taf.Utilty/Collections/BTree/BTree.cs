...
namespace Taf.Utility{
    ...
    public class BTree<T> where T : IComparable{
        ...
        public BTree(IBTreeNode<T> rootNode) => Root = rootNode;

        /// <summary>
        ///     获取根节点
        /// </summary>
        public IBTreeNode<T> Root{ get; private set; }
        ...
        /// <returns></returns>
        public IBTreeNode<T> CreateNode(T data) => new BIbTreeNode<T>{ Data = data };
        ...
        public IBTreeNode<T> GetGrandParent(IBTreeNode<T> targetNode){
            ...
            && !targetNode.Parent.Parent.IsNull){
        ...
        private void LocateNewNodePosition(IBTreeNode<T> newNode){
            ...
            var           comparedNode = Root; //从根节点开始查找
        ...
        public static void BuildTree(BTree<T> bTree, List<BTreeBuildNode<T>> dlrList, List<BTreeBuildNode<T>> ldrList){
            ...
            while(dlrIndex < dlrList.Count){
                if(0 != buildStack.Count
                && 0 == buildStack.Peek().Data.CompareTo(ldrList[ldrIndex].Data)){
    ...
    #region 插入
        ...
        private void InsertCase3(IBTreeNode<T> targetNode){
            ...
            if(!uncle.IsNull
            && BTreeNodeColor.Red == uncle.Colour){
        ...
        public IBTreeNode<T> Insert(T item){
            ...
            if(Root.IsNull){
                Root        = newNode;
                Root.Colour = BTreeNodeColor.Black;
                return Root;
            }
